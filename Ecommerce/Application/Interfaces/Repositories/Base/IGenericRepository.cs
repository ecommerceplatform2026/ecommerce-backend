...
namespace Application.Interfaces.Repositories.Base
{
    public interface IGenericRepository<T> where T : BaseEntity
    {
        ...
        Task<T?> FindIgnoreQueryFiltersAsync(Expression<Func<T, bool>> predicate, bool asNoTracking = true, CancellationToken cancellationToken = default, params Expression<Func<T, object>>[] includes);
